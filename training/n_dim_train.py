...
T = 5.0         # Temperature (adjust as needed)
num_samples = 5000
...
flat_chain["-loglike"]     = sampled_chain[:, 1] * T # multiply by T to get the original -loglike values
for i in range(dim):
...
with open(os.path.join(data_dir, "6d_param_scaler.pkl"), "wb") as f:
    pickle.dump(scaler_X, f)
with open(os.path.join(data_dir, "6d_target_scaler.pkl"), "wb") as f:
...
with open(os.path.join(data_dir, "6d_training_history.pkl"), "wb") as f:
...
plt.savefig(os.path.join(plots_dir, "6d_training_history.png"))
plt.close()

# ----------------------------
# 8. Save the Trained Model
# ----------------------------
model.save(os.path.join(model_dir, "6d_model.h5"))
