...
model_path = os.path.join("models", "2dg_hps_trained_model.h5")
...
param_scaler_path = os.path.join(data_dir, "2dg_hps_param_scaler.pkl")
target_scaler_path = os.path.join(data_dir, "2dg_hps_target_scaler.pkl")
...
model = load_model("models/2dg_hps_trained_model.h5")
